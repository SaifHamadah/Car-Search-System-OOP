...
public class sedan extends Car {
	...
	private String d;
	private double h;
	public sedan(String brand, String model, int year, String color, String fuelType, int topSpeed,
	...
	public void printCarInfo()		//print function to print this class attributes
	{
		...
		System.out.println("The abilities of the Sedan car : "+getB());		//using the getter function to print the info
